    ...
    <section class="hero py-28">
        <div class="container mx-auto flex flex-col md:flex-row justify-between 2xl:justify-evenly  items-center px-4">
            <div class="hero__content space-y-3 mb-20 ">
                ...
                <h4 class="text-red-400 mb-2">B.Sc Hon's in CSE</h4>
                <p class="text-slate-500">I’m a highly motivated, ambitious, and creative person who can make <br/> you happy to develop an amazing website.</p>
            </div>
            <div class="hero__image">
                <img src="/assets/images/hero.png" alt="My-Image">
            </div>
        </div>
    </section>
</template>-